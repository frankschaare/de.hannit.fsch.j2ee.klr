...
private TreeMap<Integer, MitarbeiterMBean> team1 = new TreeMap<Integer, MitarbeiterMBean>();
private TreeMap<Integer, MitarbeiterMBean> team2 = new TreeMap<Integer, MitarbeiterMBean>();
private TreeMap<Integer, MitarbeiterMBean> team3 = new TreeMap<Integer, MitarbeiterMBean>();
private TreeMap<Integer, MitarbeiterMBean> team4 = new TreeMap<Integer, MitarbeiterMBean>();
private TreeMap<Integer, TreeMap<Integer, MitarbeiterMBean>> teams = new TreeMap<Integer, TreeMap<Integer, MitarbeiterMBean>>();
...
private TreeMap<String, ArbeitszeitanteilMBean> aufteilungGemeinKosten = null;
...
private boolean datenOK = false;
	...
	public void splitTeams()
	{
		...
		{
			int test = m.getAzvMonat().get(m.getAzvMonat().size()-1).getITeam();
	...
	private void setGesamtsummeProzentanteile()
	{
		...
		{
		TreeMap<Integer, MitarbeiterMBean> team = teams.get(i); 	
		int gesamtsummeProzentanteile = 0;

			for (MitarbeiterMBean m : team.values())
			{
	...
	public TreeMap<String, ArbeitszeitanteilMBean> getAufteilungGemeinKosten()
	{
	return aufteilungGemeinKosten != null ? aufteilungGemeinKosten : new TreeMap<String, ArbeitszeitanteilMBean>();
	}
	...
	ArbeitszeitanteilMBean vorhanden = null;
	TreeMap<Integer, MitarbeiterMBean> team = null;
	int teamNR = 0;
	int gesamtSummeProzentAnteile = 0;
	int summeProzentanteilKTR = 0;
		 ...
		 */
		aufteilungGemeinKosten = new TreeMap<String, ArbeitszeitanteilMBean>();
		for (MitarbeiterMBean m : team.values())
		{
			for (ArbeitszeitanteilMBean azv : m.getAzvMonat())
			{
		...
		for (ArbeitszeitanteilMBean azv : aufteilungGemeinKosten.values())
		{
