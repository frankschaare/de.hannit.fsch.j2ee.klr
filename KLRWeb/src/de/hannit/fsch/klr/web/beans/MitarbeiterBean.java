 ...
 *
 */
public class MitarbeiterBean extends Person 
{
...
private int azvProzentSumme = 0;
	...
	this.teamMitgliedschaften = teamMitgliedschaften;
		...
		{
		case 6:
		setStatus(MitarbeiterBean.STATUS_AUSZUBILDENDER);	
		break;
		case 7:
		setStatus(MitarbeiterBean.STATUS_ALTERSTEILZEIT_ANGESTELLTE);	
		break;
		case 8:
		setStatus(MitarbeiterBean.STATUS_ALTERSTEILZEIT_BEAMTE);	
		break;
	...
	public void setStatus(int status)
	{
		switch (this.status)
		{
		case MitarbeiterBean.STATUS_AUSZUBILDENDER:
		break;
		case MitarbeiterBean.STATUS_ALTERSTEILZEIT_ANGESTELLTE:
		break;
		case MitarbeiterBean.STATUS_ALTERSTEILZEIT_BEAMTE:
		break;
		default:
		this.status = status;
		break;
